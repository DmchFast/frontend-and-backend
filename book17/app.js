...
// Получение события от других клиентов (Socket.IO)
...
async function subscribeToPush() {
    ...
    try {
        ...
        const subscription = await registration.pushManager.subscribe({
            ...
            applicationServerKey: urlBase64ToUint8Array('BOJiaqcO7tfLgZPenU247ZsowLKXNQS3y6Riej9mBN8s5MlAT1iFUqWXycy-ul5BwwOhgs-ejlKhsSCIrN2fFqE')
        });
